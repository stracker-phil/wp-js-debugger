...
(function() {
	...
	class ApplePaySessionStub extends Emitter {
		constructor(version, paymentRequest) {
			...
			alert('This Apple Pay button is a non-functional preview');
		}
		...
		begin() {
			...
			const event = new ApplePayValidateMerchantEvent(url);
	...
	// Initialize the fake Apple Wallet
	ApplePaySessionStub.stubCanMakePayments = !window.JS_DEBUG_CONFIG?.emptyAppleWallet;
